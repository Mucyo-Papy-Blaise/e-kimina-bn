...
export function renderTreasurerInvitationEmail(
  ...
  const bodyHtml = `
    <h2 style="color: #0E7A4D; margin-bottom: 20px;">Treasurer invitation</h2>
    <p>Hello,</p>
    <p>You have been invited to join <strong>${escapeHtml(groupName)}</strong> on <strong>E-Kimina</strong> as a <strong>Treasurer</strong>.</p>
    ...
    <p style="color: #666; font-size: 14px;">The registration form will prefill your email (you cannot change it). After you register, your treasurer access becomes active.</p>
